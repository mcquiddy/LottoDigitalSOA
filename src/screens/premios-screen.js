...
/*
Ventana que muestra un listado de los premios
*/
export default class PremioScreen extends React.Component {
    constructor(props) {
    super(props);
    const ds = new ListView.DataSource({ rowHasChanged: (r1, r2) => r1 !== r2  });
    this.state = {
                    dataSource: ds.cloneWithRows(global.PremiosNumbers)
                 };
    }
